...
class calc: 
	...
	def sin(self): 
		...
		try: 
			...
			self.sqval= round(math.sin(math.radians(self.value)),1)
			self.e.delete(0,END)
			self.e.insert(0,self.sqval)
	def cos(self): 
		"""square method"""
		...
		try: 
			...
			self.sqval=round(math.cos(math.radians(self.value)),1)
			self.e.delete(0,END) 
			self.e.insert(0,self.sqval)
	...
	def tan(self): 
		...
		try: 
			...
			self.sqval=round(math.tan(math.radians(self.value)),1)
			self.e.delete(0,END) 
			self.e.insert(0,self.sqval)
	def log(self): 
		"""square method"""
		...
		try: 
			...
			self.sqval=math.log10(self.value)
			self.e.delete(0,END) 
			self.e.insert(0,self.sqval) 
	...
	def __init__(self,master): 
			...
			self.e.grid(row=0,column=0,columnspan=10,pady=10) 
			...
			Button(master,text="sin",width=5,height=3, 
				fg="black",bg="yellow", 
				command=lambda:self.sin()).grid(row=1, column=6)
			Button(master,text="cos",width=5,height=3, 
				fg="black",bg="yellow", 
				command=lambda:self.cos()).grid(row=2, column=6)
			Button(master,text="tan",width=5,height=3, 
				fg="black",bg="yellow", 
				command=lambda:self.tan()).grid(row=3, column=6)
			Button(master,text="log",width=5,height=3, 
				fg="black",bg="yellow", 
				command=lambda:self.log()).grid(row=4, column=6)
